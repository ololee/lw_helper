...
workers = read_model_config("../static/config/csv/lw_hero.csv")
...
for worker in workers:
    ...
    trans_set.add(worker["title_name"])
...
with open("../static/config/json/hero_trans.json","w",encoding="utf-8") as f:
    f.write(out_json)
